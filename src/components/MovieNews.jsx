...
useEffect(() => {
    const getMovieNews = async () => {
      ...
      let data = localStorage.getItem("MnewsData");
      if (data) {
      ...
      setMovieNews(data);
      dispatchMovieNews(addMovieNewsSlice(data));
  ...
  const Images = MovieNews && MovieNews.map(item => item?.node?.image?.url)
  console.log(Images)
  ...
  return (
    ...
    <div className=" bg-black -mt-10 ">
      ...
      <div className=" text-[1.8vw] relative left-[30vw] bottom-[77vh] flex">
        ...
        <h1 className=" text-emerald-400 font-semibold">Movie News</h1>
      </div>
