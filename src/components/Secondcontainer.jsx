...
const Secondcontainer = () => {
  ...
  return (
    <>
      ...
      <>
        <div className="mt-[4vw] mb-5 px-5 text-3xl leading-relaxed text-fuchsia-500 dark:text-yellow-300 bg-black font-thin">
        ...
        <div className=" px-5 py-4 bg-black">
          ...
          >
            {" "}
            <img
              className=" w-[1.3vw] rounded-lg justify-center inline mr-1 "
          ...
          >
            {" "}
            <img
              className=" w-[1.2vw] rounded-xl justify-center inline-block mr-1"
          ...
          >
            {" "}
            <img
              className="w-[1.3vw] rounded-xl justify-center inline-block mr-1"
          ...
          >
            {" "}
            <img
              className="w-[1.6vw] rounded-xl justify-center inline-block mr-1"
          ...
          >
            {" "}
            <img
              className="w-[1.6vw] h-[2.5vh] rounded-xl justify-center inline-block mr-1"
          ...
          >
            {" "}
            <img
              className="w-[1.3vw] h-[2vh] rounded-md justify-center inline-block mr-1"
