        ...
        <>
            ...
            <>
                ...
                <div className=' px-5 py-4 bg-black'>
                    ...
                    <button className='text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Netflix')}> <img className=' w-[1.2vw] rounded-xl justify-center inline-block mr-1' src="https://www.underconsideration.com/brandnew/archives/netflix_app_icon.jpg" alt="" />NETFLIX</button>
                    <button className='text-white bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 shadow-lg shadow-yellow-500/50 dark:shadow-lg dark:shadow-yellow-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Apple TV+')}> <img className='w-[1.3vw] rounded-xl justify-center inline-block mr-1' src="https://logowik.com/content/uploads/images/apple-tv1519.jpg" alt="" />APPLE TV+</button>
                    <button className='text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Hulu')}> <img className='w-[1.3vw] rounded-xl justify-center inline-block mr-1' src="https://i.pinimg.com/474x/8c/d1/10/8cd11044810e9c8d6e2fc2597a2c68a0.jpg" alt="" />HULU</button>
                    <button className='text-white bg-gradient-to-r from-purple-400 via-purple-500 to-purple-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Max')}> <img className='w-[1.6vw] rounded-xl justify-center inline-block mr-1' src="https://logos-world.net/wp-content/uploads/2022/01/HBO-Max-Logo.jpg" alt="" />MAX</button>
                    <button className='text-white bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 shadow-lg shadow-gray-500/50 dark:shadow-lg dark:shadow-gray-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Peacock')}> <img className='w-[1.3vw] rounded-xl justify-center inline-block mr-1' src="https://i.pinimg.com/736x/79/31/0e/79310ef5ca4e9027456695b12d0ecbe3.jpg" alt="" />PEACOCK</button>
                    <button className='text-white bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-emerald-300 dark:focus:ring-emerald-800 shadow-lg shadow-emerald-500/50 dark:shadow-lg dark:shadow-emerald-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Freevee')}> <img className='w-[1.3vw] rounded-xl justify-center inline-block mr-1' src="https://static.amazon.jobs/teams/610/thumbnails/freevee_social_banners_v4_543x543_%281%29.jpg?1661462055" alt="" />FREEVEE</button>
                    <button className='text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('Paramount+')}> <img className='w-[1.6vw] h-[2.5vh] rounded-xl justify-center inline-block mr-1' src="https://cdn.mos.cms.futurecdn.net/N95U8Msuh66Drmf7kGjFAa.jpg" alt="" />PARAMOUNT+</button>
                    <button className='text-white bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-orange-300 dark:focus:ring-orange-800 shadow-lg shadow-orange-500/50 dark:shadow-lg dark:shadow-orange-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('AMC+')}> <img className='w-[1.6vw] h-[2.5vh] rounded-xl justify-center inline-block mr-1' src="https://shop.amc.com/cdn/shop/products/AMCP-LOGO-100011-FR-RO_1445x.png?v=1650990755" alt="" />AMC+</button>
                    <button className='text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('STARZ')}> <img className='w-[1.3vw] h-[2vh] rounded-md justify-center inline-block mr-1' src="https://i0.wp.com/www.thewrap.com/wp-content/uploads/2017/12/StarzLogo.jpg?fit=618%2C412&ssl=1" alt="" />STARZ</button>
                    <button className='text-white bg-gradient-to-r from-slate-400 via-slate-500 to-slate-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-slate-300 dark:focus:ring-slate-800 shadow-lg shadow-slate-500/50 dark:shadow-lg dark:shadow-slate-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2' onClick={() => handleProviderClick('SHOWTIME')}> <img className='w-[1.6vw] h-[2.5vh] rounded-xl justify-center inline-block mr-1' src="https://www.cnet.com/a/img/resize/b5bbd7811f6980d51dd0af7983f5827d3aa5e92e/hub/2023/01/04/8922e8a7-64be-458a-9cc9-60f9086d25d2/3-10.png?auto=webp&fit=crop&height=900&width=1200" alt="" />SHOWTIME</button>
                </div>
