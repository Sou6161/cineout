...
const CelebrityNews = () => {
  ...
  const dispatchcelebNews = useDispatch();
  ...
  useEffect(() => {
    const getCelebNews = async () => {
      ...
      setCelebrityNews(data);
      dispatchcelebNews(addCelebrityNewsSlice(data));
  ...
  const Images = CelebrityNews && CelebrityNews.map((item) => item?.node?.image?.url);
  console.log(Images);
    ...
    <>
      ...
      <div className=" bg-black -mt-10 ">
        ...
        <div className=" text-[1.8vw] relative left-[30vw] bottom-[77vh] flex">
          ...
          <h1 className=" text-emerald-400 font-semibold">Celebrity News</h1>
        </div>
