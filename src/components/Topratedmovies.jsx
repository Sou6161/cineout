...
const Topratedmovies = ({ finaltopratedmovies }) => {
  return (
    <div
      className=" bg-black flex gap-4 absolute top-[10vw]  w-[100vw] h-[210vh] overflow-y-scroll no-scrollbar "
      style={{
        display: "grid",
    ...
    >
        {console.log(finaltopratedmovies)}
      {finaltopratedmovies &&
        finaltopratedmovies.map((item, index) => (
          <>
            {" "}
            <div
              key={index}
