...
const Freeveevideos = ({ finalfreeveemovies }) => {
  return (
    <div className=" flex gap-5  w-[92vw] xsmall:w-[94vw] small:w-[96vw] medium:w-[96vw] large:w-[97vw] xlarge:w-[98vw] 2xlarge:w-[97.5vw] h-[60vh] mt-5 overflow-y-hidden bg-lime-30  no-scrollbar">
      {finalfreeveemovies &&
        finalfreeveemovies.map((item, index) => (
          <>
            {" "}
