...
const Appletvvideos = ({ finalappletvmovies }) => {
  return (
    <div className=" flex gap-5  w-[92vw] xsmall:w-[94vw] small:w-[96vw] medium:w-[96vw] large:w-[97vw] xlarge:w-[98vw] 2xlarge:w-[94vw] h-[65vh] mt-5 overflow-y-hidden bg-lime-30  no-scrollbar">
      {finalappletvmovies &&
        finalappletvmovies.map((item, index) => (
          <>
            {" "}
            <div
              key={index}
              className=" mr-4 bg-black  ml-5 max-w-[52vw] max-h-[42vh] xsmall:max-w-[40vw] small:max-w-[30vw] medium:max-w-[30vw] large:max-w-[25vw] xlarge:max-w-[20vw] 2xlarge:max-w-[15vw] rounded-[10px] relative top-6  p-2 glow3"
            >
              <img
