...
const Whattowatchmovies = ({ finalwatchmovies }) => {
  return (
    <>
      {console.log(finalwatchmovies)}
      <div
        className=" bg-black flex gap-4 p-5 absolute top-[10vw] backdrop-blur-md  w-[100vw] h-[250vh] overflow-y-scroll no-scrollbar "
        style={{
          display: "grid",
      ...
      >
        {finalwatchmovies &&
          finalwatchmovies.map((item, index) => (
            <div
              key={index}
